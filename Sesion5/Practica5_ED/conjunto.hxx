...
template <typename T, typename CMP>
conjunto<T,CMP>::value_type conjunto<T,CMP>::iterator::operator *(){
    return (*it);
}

template <typename T, typename CMP>
conjunto<T,CMP>::iterator& conjunto<T,CMP>::iterator::operator ++(){
    it++;
    return (*this);
}
...
template <typename T, typename CMP>
conjunto<T,CMP>::iterator conjunto<T,CMP>::iterator::operator ++(int i){
    it += i;
    return (*this);
}
...
template <typename T, typename CMP>
conjunto<T,CMP>::iterator& conjunto<T,CMP>::iterator::operator =(const iterator& x){
    it = x.it;
    return (*this);
}
/*******************************************************************************************/
...
conjunto<T,CMP>::iterator conjunto<T,CMP>::begin(){
    iterator ite(vm.begin());
    return ite;
}

template <typename T, typename CMP>
conjunto<T,CMP>::iterator conjunto<T,CMP>::cbegin(){
    const_iterator ite(vm.begin());
    return ite;
}
...
template <typename T, typename CMP>
conjunto<T,CMP>::iterator conjunto<T,CMP>::cend(){
    const_iterator ite(vm.end());
    return ite;
}
/***************************************************/
